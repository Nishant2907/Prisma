...
function App() {
  ...
  return !!schema ? (
    <>
      <Text fontSize='3xl' as='b' mb={5}>Prisma</Text>
      <Card w="xl" p={10} background="rgba(255,255,255,.90)">
        <Heading mb={5}> Claim your AGE Verification</Heading>
        {/* <Heading mb={5}> Claim your {pascalStrToSpacedWord(schema.schema)}</Heading> */}
